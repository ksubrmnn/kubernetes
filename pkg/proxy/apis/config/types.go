...
type KubeProxyWinkernelConfiguration struct {
	// hnsNetworkName is the name of the network kube-proxy will use 
	// to create endpoints and policies
	HNSNetworkName string
	// sourceVip is the IP address of the source VIP endoint used for 
	// NAT when loadbalancing in non DSR mode
	SourceVip string
	// enableDSR tells kube-proxy whether HNS policies should be created 
	// with DSR
	EnableDSR bool
	// hostMac is the MAC address of the Management NIC of the node
	HostMac string
}
